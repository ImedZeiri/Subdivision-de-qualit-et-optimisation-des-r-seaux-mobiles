...
class Technicien:
    def main(self):
        ...
        def Mesure():
            ...
            Window.BTNValide = Button(Frame1)
            Window.BTNValide.place(relx=0.09459, rely=0.327, height=30, width=110)
            Window.BTNValide.configure(activebackground="#ececec")
            Window.BTNValide.configure(activeforeground="#000000")
            Window.BTNValide.configure(background="#d9d9d9")
            Window.BTNValide.configure(disabledforeground="#a3a3a3")
            Window.BTNValide.configure(foreground="#000000")
            Window.BTNValide.configure(highlightbackground="#d9d9d9")
            Window.BTNValide.configure(highlightcolor="black")
            Window.BTNValide.configure(pady="0")
        ...
        Window.BTNMeusure = Button(Window)
        Window.BTNMeusure.place(relx=0.09459, rely=0.327, height=30, width=110)
        Window.BTNMeusure.configure(activebackground="#ececec")
        Window.BTNMeusure.configure(activeforeground="#000000")
        Window.BTNMeusure.configure(background="#d9d9d9")
        Window.BTNMeusure.configure(disabledforeground="#a3a3a3")
        Window.BTNMeusure.configure(foreground="#000000")
        Window.BTNMeusure.configure(highlightbackground="#d9d9d9")
        Window.BTNMeusure.configure(highlightcolor="black")
        Window.BTNMeusure.configure(pady="0")
        Window.BTNMeusure.configure(text="Mesures")
        Window.BTNMeusure.configure(command=Mesure)



        Window.BTNMaintenance = Button(Window)
        Window.BTNMaintenance.place(relx=0.09459, rely=0.427, height=30, width=110)
        Window.BTNMaintenance.configure(activebackground="#ececec")
        Window.BTNMaintenance.configure(activeforeground="#000000")
        Window.BTNMaintenance.configure(background="#d9d9d9")
        Window.BTNMaintenance.configure(disabledforeground="#a3a3a3")
        Window.BTNMaintenance.configure(foreground="#000000")
        Window.BTNMaintenance.configure(highlightbackground="#d9d9d9")
        Window.BTNMaintenance.configure(highlightcolor="black")
        Window.BTNMaintenance.configure(pady="0")
